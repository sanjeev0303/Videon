        ...
        >
          ...
          <Command.List className="max-h-75 overflow-y-auto overflow-x-hidden p-2">
            ...
            >
              ...
              <CommandItem
                onSelect={() => runCommand(() => router.push("/dashboard/deployment"))}
              >
                <Server className="mr-2 h-4 w-4" />
                <span>OneMinute Deploy</span>
              </CommandItem>
              <CommandItem
                onSelect={() => runCommand(() => router.push("/dashboard/redis"))}
              >
                <Zap className="mr-2 h-4 w-4" />
                <span>Redis</span>
              </CommandItem>
              <CommandItem
                onSelect={() => runCommand(() => router.push("/dashboard/storage"))}
              >
                <HardDrive className="mr-2 h-4 w-4" />
                <span>Storage</span>
              </CommandItem>
              <CommandItem
                onSelect={() => runCommand(() => router.push("/dashboard/media-convert"))}
              >
                <FileVideo className="mr-2 h-4 w-4" />
                <span>Media Convert</span>
              </CommandItem>
              <CommandItem
                onSelect={() => runCommand(() => router.push("/dashboard/cdn"))}
              >
